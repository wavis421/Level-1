...
public class Jeopardy implements ActionListener {
	...
	private void start() {
		...
		JPanel topic1Panel = createHeader("Topic 1");
		// 4. Add the header component to the quizPanel
		quizPanel.add(topic1Panel);
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if (buttonPressed == firstButton) {
			...
			askQuestion("What is your name?", "Wendy", 200);
		...
		// Or if the buttonPressed was the secondButton
			...
			askQuestion("How old are you?", "50", 500);
		}
	...
	if (answer.equals(correctAnswer)) {
		score += prizeMoney;
		updateScore();
		JOptionPane.showMessageDialog(this.quizPanel, "You're correct!");
		...
		score -= prizeMoney;
		JOptionPane.showMessageDialog(this.quizPanel, "Wrong! The answer is " + correctAnswer);
		updateScore();
